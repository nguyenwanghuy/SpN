...
<!-- header -->
    <nav class="navbar navbar-expand-sm navbar-dark bg-success sticky-top" style="background-image:url(https://wallpaperset.com/w/full/6/6/4/125431.jpg); font-size: large;"> 
        <div class="container">
            <a class="navbar-brand" href="/SpN/index.html"><img src="/SpN/images/anh/LOGO (1).png" style="width: 100%;height: 50px"></a>
            <ul class="navbar-nav ms-auto me-5" style="gap: 20px">
                <li class="nav-item">
                    <a href="/SpN/index.html" class="nav-link">Trang chủ</a>
                </li>
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown">Môn học</a>
                    <ul class="dropdown-menu">
                    <li><a class="dropdown-item" href="detail.html?id=1">Vũ Đạo và Nghệ Thuật</a></li>
                    <li><a class="dropdown-item" href="detail.html?id=2">Truyền Thông</a></li>
                    <li><a class="dropdown-item" href="detail.html?id=3">Triết Học Đại Cương</a></li>
                    <li><a class="dropdown-item" href="detail.html?id=4">Tài Chính - Ngân Hàng</a></li>
                    <li><a class="dropdown-item" href="detail.html?id=5">Kinh Tế Vi Mô</a></li>
                    <li><a class="dropdown-item" href="detail.html?id=6">Tâm Lý Học Đại Cương</a></li>
                    <li><a class="dropdown-item" href="detail.html?id=7">Tư Pháp Đại Cương</a></li>
                    <li><a class="dropdown-item" href="detail.html?id=8">Luật Đại Cương</a></li>
                    <li><a class="dropdown-item" href="detail.html?id=9">Tham Vấn</a></li>
                    <li><a class="dropdown-item" href="detail.html?id=10">Toán Cao Cấp</a></li>
                    <li><a class="dropdown-item" href="detail.html?id=11">Âm nhạc</a></li>
                    <li><a class="dropdown-item" href="detail.html?id=12">Kiến trúc</a></li>
                ...
                <li class="nav-item">
                    <a href="result_quiz.html" class="nav-link">Đố vui</a>
                </li>
            ...
            <ul class="navbar-nav" id='navbar-abc'>
                <li class="nav-item me-2">
                    <button class="btn btn-outline-primary"><a class="nav-link" href="login.html">Đăng nhập</a></button>
                </li>
                <li class="nav-item">
                    <button class="btn btn-outline-success"><a class="nav-link" href="login.html">Đăng ký</a></button>
                </li>
            </ul>
